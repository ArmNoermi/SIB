    ...
    <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right">
                <a href="<?= site_url('dkmn_klr') ?>" class="btn btn-warning btn-flat">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <?= form_open_multipart('dkmn_klr/process') ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tujuan" value="<?php echo $row->tujuan ?>" class="form-control" required>
                    </div>
